...
export type TeamListItemTeamFragmentFragment = { __typename?: 'Team', id: string, title: string, slug: string, contacts: { __typename?: 'ContactConnection', totalCount: number } } & { ' $fragmentName'?: 'TeamListItemTeamFragmentFragment' };
